  ...
  <c-card>
    ...
    <n-collapse mb-3>
      <n-collapse-item :title="t('tools.ssl-certificate-parser.help.title')" name="help">
        <n-h4 prefix="bar">
          {{ t('tools.ssl-certificate-parser.help.section1Title') }}
        </n-h4>
        ...
        <n-h4 prefix="bar">
          {{ t('tools.ssl-certificate-parser.help.section2Title') }}
        </n-h4>
        <n-ul>
        ...
        <n-h4 prefix="bar">
          {{ t('tools.ssl-certificate-parser.help.section3Title') }}
        </n-h4>
        <n-ul>
        ...
        <n-h4 prefix="bar">
          {{ t('tools.ssl-certificate-parser.help.section4Title') }}
        </n-h4>
        <n-config-provider :hljs="hljs">
          <n-code :code="sampleCertificate" />
        </n-config-provider>
      </n-collapse-item>
    </n-collapse>
